...
class InputWidgetMaker {
    ...
    fun register(predicate: (parameterType: KType) -> Boolean, widgetMaker: (prompt: String, screen: Screen, outArgs: MutableList<Any?>, arg: KParameter) -> ClickableWidget) {
    ...
    private data class WidgetRegistryEntry(
        ...
        val widgetMaker: (prompt: String, screen: Screen, outArgs: MutableList<Any?>, arg: KParameter) -> ClickableWidget) {
    }
}